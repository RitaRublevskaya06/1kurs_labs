...
int countLeaves(Tree* t); //Подсчета количества листьев данного дерева
...
int main()
{
	...
	for (;;)
	{
		...
		cout << "5 - Вывод дерева\n";
		cout << "6 - Подсчета количества листьев данного дерева\n";
		...
		case 6:  n = countLeaves(Root);
			cout << "Количество листьев дерева: " << n << endl;
			break;
