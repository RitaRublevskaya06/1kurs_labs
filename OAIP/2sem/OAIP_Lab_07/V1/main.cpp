...
int main() {
    ...
    std::cout << "7 - Построение стеков из положительных и отрицательных элементов" << std::endl;
    std::cout << "8 - Выход" << std::endl << std::endl;
    ...
    for (;;) {
        ...
        case 7:
            ...
            std::cout << "Положительный ";
            display(positiveStack);
            std::cout << "Отрицательный ";
